    ...
    >
      ...
      <div className="flex flex-col pt-40 md:pt-0 select-none">
        ...
        <h1 className={`${styles.heroName} text-white text-6xl font-semibold`}>
          <span className={`relative ${styles.emphasize} seq`}>Swagatam</span>
          <span className="seq"> Bhattacharjee</span>
        </h1>
        <p>
          <span
            ref={typedEl}
        ...
        <div className="seq pt-4">
          <Button
            href={`https://www.linkedin.com/in/swagatam-bhattacharjee-5aa00a1b2/`}
            classes="link"
            type="primary"
          >
            Let&apos;s Connnect
